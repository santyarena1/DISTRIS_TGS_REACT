...
// ✅ AQUÍ AGREGAMOS GAMING CITY A LA LISTA MAESTRA
const defaultSettings: Record<string, DistributorSettings> = {
  ...
  gamingcity: { name: 'Gaming City', whatsapp: '5491100000000' }, // <--- NUEVO
};
...
export function SettingsProvider({ children }: { children: ReactNode }) {
  ...
  // Teléfonos (Con fusión inteligente para que aparezca lo nuevo)
  const [distributorSettings, setDistributorSettings] = useState<Record<string, DistributorSettings>>(() => {
    ...
    // Fusión: Aseguramos que Gaming City aparezca aunque tengas datos viejos guardados
