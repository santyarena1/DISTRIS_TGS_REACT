...
import { Loader2, Save, RefreshCw, Eye, EyeOff, Server, Upload, FileSpreadsheet, MoreVertical, Edit, Trash2 } from 'lucide-react';
...
export function ConfigPage() {
  ...
  const handleSync = async (distributor: string) => {
    ...
    try {
      await apiClient.syncDistributor(distributor);
            ...
            <div className="grid gap-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h2 className="text-2xl font-bold">Proveedores con Importación Excel</h2>
                    <p className="text-sm text-muted-foreground mt-1">
                      Administrá proveedores que importan productos desde archivos Excel
                    </p>
                  </div>
                </div>
                <SuppliersPage />
